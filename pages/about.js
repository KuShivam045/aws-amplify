...
const about = (props) => {
  const pages = [
    {
      name: "About",
      href: "https://www.rozgaarindia.com/about",
      current: true,
    },
  ];
  const logoSchema = {
  ...
  return (
    <div>
      ...
      <meta
        ...
        <meta
          property="og:url"
          content="https://www.rozgaarindia.com/about"
        />
        <meta
          property="og:image"
      ...
      <div className={classes.headBg}>
        ...
        <div className={classes.headImg}>
          <img
            src={"/ChiefOffier.svg"}
            className="h-[140%] w-full hidden lg:block"
            alt="Chief_Operating_Officer_RozgaarIndia"
            title="Chief_Operating_Officer_RozgaarIndia"
            loading="lazy"
            
          />
          <img
            src={"/ChiefOffier.svg"}
            className={classes.headImgphotoMob}
            alt="Chief_Operating_Officer_RozgaarIndia"
            title="Chief_Operating_Officer_RozgaarIndia"
            loading="lazy"
            width={"100%"}
          ...
          <div className={classes.swptextBox}>
            <img
              src={"/assets/AboutUs/entrepreneurLogo.png"}
              className={classes.logoweb}
              alt="entrepreneur_Logo"
              title="entrepreneur_Logo"
              loading="lazy"
              width={160}
              height={60}
            />
            ...
            <div className={classes.swpdetailhead}>
              FOUNDER AND CHIEF OPERATING OFFICER, ROZGAARINDIA.COM & PARTNER,
              TIMESASCENT.COM
            </div>
            <img
              src={"/assets/AboutUs/entrepreneurLogo.png"}
            ...
            <div className={classes.bnnrDetailsHead}>
              <div className={classes.bnnrparaDetails}>
                ...
                Business from the University of Greenwich - London. She is an
                accomplished Founder with an established history of working in
                the digital sector. Currently, Swapnil leads two enterprises:
                Rozgaarindia and Times Ascent.
              </div>
              <div className={classes.redstripeBoxOuter}>
                <div className={classes.redstripeBox}>
                  ...
                  <div className={classes.redstripeText}>
                    ENTERPRENEURSHIP DOES NOT REQUIRE A LARGE VOCABULARY; RATHER
                    IT REQUIRES A SIGNIFICANT VISION AND PURPOSE
                  </div>
                </div>
                <div className={classes.redstripeBox}>
                  <div className={classes.redStripe}></div>
                  <div className={classes.redstripeText}>
                    THE FUTURE IS FREELANCE. WOMEN THAT GAVE A RELIABLE & SECURE
                    PLATFORM TO EVERY FREELANCER OF THE WORLD!
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8 my-2 lg:my-4">
        <div className="">
          <div className="">
            <h1 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
              About Us <br />
              <span className="mt-1 max-w-2xl leading-6 text-gray-500 font-semibold">
                The future of work
              </span>
            </h1>
            ...
            <div className={classes.bluebar}>
              ...
              <a
                ...
                onClick={() => {
                  Cookies.set("RedirectUrl", "/par-stepfirst");
                }}
              >
