...
const customersupport = (props) => {
  ...
  let locname =
    Cookies.get("Client_FirstName") + " " + Cookies.get("Client_LastName");
  ...
  const pages = [
    {
      ...
      href: "https://www.rozgaarindia.com/employer-workplace/customer-support",
      current: true,
    },
  ];
  ...
  return (
    <div>
      ...
      <meta
        ...
        <link rel="canonical" href="https://www.rozgaarindia.com/employer-workplace/customer-support/"/>
        ...
        <meta
          property="og:url"
          content="https://www.rozgaarindia.com/employer-workplace/customer-support/"
        />
        <meta
          property="og:image"
