...
const ProposalsList = (props) => {
  ...
  const proposalDetailsApi = (proposalId) => {
    ...
    fetch(
      process.env.BASE_URL + "/api/freelancerapp/rozgaarapi/ProposalDetails",
    ...
    <div className="border border-gray-300 rounded-lg p-4">
      {props.isLoading ? <RISkeletonLoading loadingType={"ProposalsList"} /> :
        <div>
          ...
          <p className="text-prose prose">Review offers and select the best-fit freelancer</p>
                ...
                <>
                  <div className={classes.listOfProposals}>
                    ...
                    <div className={classes.buttonContainer}>
                      <BiChat className={classes.messageIcon} onClick={() => { encodeAndSendToChat(Cookies.get("Client_userID"), item.FreelancerId) }} />
                      {item.ClientRStatus === "" ?
                        <div
