            ...
            {skeletonDefaultArr.slice(0, 4).map(() => {
              return (
                ...
                >
                  <div
                    className={classes.skeletonline}
                    style={{ height: "10px", width: "230px" }}
                  ></div>
                  <div
                    className={classes.skeletonline}
                    style={{ height: "10px", width: "220px" }}
                  ></div>
                  <div
                    className={classes.skeletonline}
                    style={{ height: "10px", width: "260px" }}
                  ></div>
                  <div
                    className={classes.skeletonline}
                    style={{ height: "10px", width: "230px" }}
              ...
              {skeletonDefaultArr.slice(0, 1).map(() => {
                return (
                  <div>
                    <div
                      className={classes.skeletonline}
                      style={{ height: "20px", width: "100px", float: "right" }}
                    ></div>
                    <div className={classes.pageheader_margin}>
                      <div
                        className={classes.skeletonline}
            ...
            {skeletonDefaultArr.map(() => {
              return (
                <div className={classes.skeletonlineCircleCantainer}>
                  <div className={classes.skeletonlineCircle}></div>
