            ...
            <ul className="inline-flex items-center -space-x-px">
              ...
              <li>
                <span
                  ...
                  } px-3 py-2 text-[15px] hover:bg-indigo-100 leading-tight text-gray-500 bg-white border border-gray-300  hover:text-gray-700 cursor-pointer`}
                  onClick={(e) => {
                  ...
                  <span
                    className={`${
                      ...
                      props.page === props.maxPage
                        ? "border border-gray-300 z-10"
                        : "border border-indigo-500 z-40"
                    } px-3 py-2 text-[15px] hover:bg-indigo-100 leading-tight text-gray-500 bg-white hover:text-gray-700 cursor-pointer`}
                    onClick={(e) => {
                      change(e.target.innerText);
                    }}
                  >
                  ...
                  <span
                    className={`${
                      props.page === props.maxPage - 1
                        ? "border border-indigo-500 z-40"
                        : "border border-gray-300 z-10"
                    } z-10 px-3 py-2 text-[15px] hover:bg-indigo-100 leading-tight text-gray-500 bg-white border border-gray-300  hover:text-gray-700 cursor-pointer`}
                    onClick={(e) => {
                      change(e.target.innerText);
                    }}
                  >
